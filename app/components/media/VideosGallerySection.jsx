                ...
                <div className="container mx-auto px-4">
                    <div className="text-center mb-16">
                        <span className="text-[#17a2b8] font-semibold text-sm mb-3 block">
                            {getLang('مكتبة الفيديوهات', 'Video Library')}
                        </span>
                        <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-4">
                            {getLang('لقاءات ومشاركات إعلامية', 'Media Interviews & Participations')}
                        </h2>
                        <p className="text-gray-600 max-w-2xl mx-auto">
                            {getLang('شاهد أبرز اللقاءات التلفزيونية والمشاركات العلمية للدكتور صالح الخلف.', 'Watch Dr. Saleh AlKhalf\'s most prominent TV interviews and scientific participations.')}
                        </p>
                    </div>
                    ...
                    <div className="text-center mt-12">
                        <a
                            ...
                            target="_blank"
                            rel="noreferrer"
                            className="inline-flex items-center gap-2 px-8 py-3 bg-[#17a2b8] text-white rounded-full font-medium hover:bg-[#138496] transition-colors whitespace-nowrap cursor-pointer hover:shadow-lg transform hover:-translate-y-1"
                        >
                            {getLang('قناتنا على اليوتيوب', 'Our YouTube Channel')}
