            ...
            <div className="container mx-auto px-4 relative z-10">
                <div className="text-center mb-16">
                    ...
                    <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-4">
                        كل شيء يبدأ بخطوة، وخطوتك الأولى هي حجز الاستشارة!
                    </h2>
                </div>
                ...
                <div className="max-w-5xl mx-auto">
                    <div className="relative">
                        ...
                        <div className="grid lg:grid-cols-5 gap-8 lg:gap-4">
                            {[
                                { num: 1, title: 'الاستشارة الأولية', icon: 'ri-calendar-check-line' },
                                { num: 2, title: 'التقييم الطبي ووضع الخطة', icon: 'ri-file-list-3-line' },
                                { num: 3, title: 'التحضير قبل الجراحة', icon: 'ri-clipboard-line' },
                                { num: 4, title: 'يوم الإجراء', icon: 'ri-surgical-mask-line' },
                                { num: 5, title: 'التعافي والمتابعة', icon: 'ri-heart-pulse-line' },
                            ].map((step) => (
